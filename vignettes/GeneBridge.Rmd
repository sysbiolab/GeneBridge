...
6 - Assess the consistency of root placements.
```{r, eval=FALSE}
# Re-run permutation with nPermutations >= 1000
...
# Run 'simulateRogs' to simulate 100 ROGs
